...
// forward declaration, for convinience in refering
class Picture;
class Frame_pic;
class HCat_Pic;
class VCat_Pic;
...
// private class, for use in the implementation only
class Pic_base {
public:
  virtual ~Pic_base() {} // avoid [-Wdelete-non-virtual-dtor] warning
private:
  ...
  // thess PURE VIRTUAL FUNCTIONs make the class an interface
...
private:
  Ptr<Pic_base> p;
  Picture(Pic_base* ptr): p(ptr) {} // private constructor
};
